...
const Navbar = () => {
  ...
  return (
    ...
    src={assets.logo} alt="" className='w-28 sm:w-32 lg:w-40'/>
    </Link>  

    <div>
    {user ? 
    <div className='flex gap-2 sm:gap-3 items-center'>
    <button onClick={()=>navigate('/buy')} className='flex items-center bg-blue-100 px-4 sm:px-6 py-1.5 sm:py-3 rounded-full hover:scale-105 transition-all duration-700 gap-2'>
    <img src={assets.credit_star} alt="" className='w-5'/>
    <p className='text-xs sm:text-sm font-medium text-gray-600'>Credits left: 4</p>
    </button>
    <p className='text-gray-600 max-sm:hidden pl-4'>Hi,Talraj</p>
