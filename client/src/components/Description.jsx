...
const Description = () => {
  return (
    ...
    className='flex flex-col items-center justify-center my-24 p-6 md:px-28'>
      <h1 className='font-semibold text-3xl sm:text-4xl mb-2'>Create AI Images</h1>
      <p className='text-gray-500 mb-8'>Turn your imagination into visuals</p>

      <div className='flex justify-between flex-col gap-5 md:gap-14 md:flex-row items-center'>
